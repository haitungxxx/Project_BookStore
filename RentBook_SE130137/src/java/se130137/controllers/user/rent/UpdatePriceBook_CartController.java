 ...
 * @author haitu
 */
@WebServlet(name = "UpdatePriceBook_CartController", urlPatterns = {"/UpdatePriceBook_CartController"})
public class UpdatePriceBook_CartController extends HttpServlet {
        ...
        try {
            ...
            for (BookDTO dto : cart.getCart().values()) {
                if (dto.getId().equals(id)) {
                    newBook = new BookDTO(dto.getId(), dto.getTitle(), Integer.parseInt(quantity), dto.getPrice(), dto.getIsActive());
                }
            }
