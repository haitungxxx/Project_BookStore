...
<html>
    ...
    <body>
        <c:if test="${sessionScope.LOGIN_USER.fullName == null or !sessionScope.LOGIN_USER.roleID.equalsIgnoreCase('user') or !sessionScope.LOGIN_USER.isActive.equalsIgnoreCase('true')}">
            ...
            <c:when test="${not empty sessionScope.CART}">
                            ...
                            <tbody>
                                ...
                                <form action="MainController">
                                    <tr>
                                        ...
                                        <td> 
                                            <input type="submit" value="UpdatePrice" name="btnAction" />
                                        </td>
                                    </tr>
                                </form>
                            </c:forEach>
                ...
                <c:otherwise>
                    ...
                    <form action="MainController" method="GET">
                        ...
                        <input type="hidden" name="btnAction" value="SearchBook" />
